    ...
    .tab_text {
      ...
      &:hover {
        ...
        &:first-child::before {
          ...
          width: 36px;
          height: 36px;
          background: url("~_img/tab1_act.png");
          background-size: 100% 100%;
          margin-right: 40px;
        }
        &:nth-child(2)::before {
          ...
          width: 36px;
          height: 36px;
          background: url("~_img/tab2_act.png");
          background-size: 100% 100%;
          margin-right: 40px;
        }
        &:nth-child(3)::before {
          ...
          width: 36px;
          height: 36px;
          background: url("~_img/tab3_act.png");
          background-size: 100% 100%;
          margin-right: 40px;
        }
      }
